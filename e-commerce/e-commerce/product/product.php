...
<head>
  ...
  <title>Products | PTC E-CART</title>
...
<body>
              ...
              <form action="" class="form-submit">
                <div class="row p-2">
                  ...
                  <div class="col-md-6 py-1 pl-4">
                    <b>Available Stock:</b> <span class="text-success stock-qty"><?= $row['product_qty'] ?></span>
                  </div>
                </div>
                <div class="row p-2">
                  ...
                  <div class="col-md-6">
                    <input type="number" class="form-control order-qty" min="1" max="<?= $row['product_qty'] ?>" value="1" required>
                  </div>
                </div>
               
                <input type="hidden" class="pid" value="<?= $row['id'] ?>">
                <input type="hidden" class="pname" value="<?= htmlspecialchars($row['product_name']) ?>">
                <input type="hidden" class="pprice" value="<?= $row['product_price'] ?>">
                <input type="hidden" class="pimage" value="<?= $row['product_image'] ?>">
                <input type="hidden" class="pcode" value="<?= $row['product_code'] ?>">
                <input type="hidden" class="pstock" value="<?= $row['product_qty'] ?>">
  ...
  <div class="footer">
    &copy; PTC E-CART. All rights reserved. PATEROS TECHNOLOGICAL COLLEGE | <a href="#">Privacy Policy</a>
  </div>
